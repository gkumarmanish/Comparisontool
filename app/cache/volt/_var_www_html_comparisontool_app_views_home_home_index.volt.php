...
<script src="<?php echo $public_path; ?>js/jquery-ui.min.js"></script>
  <link rel="stylesheet" type="text/css" media="all" href="<?php echo $public_path; ?>style.css">
<script type="text/javascript" src="<?php echo $public_path; ?>js/jquery-1.9.1.min.js"></script>
  <script type="text/javascript" src="<?php echo $public_path; ?>js/jquery.autocomplete.min.js"></script>
  <script type="text/javascript" src="<?php echo $public_path; ?>js/currency-autocomplete.js"></script>
</head>
...
<div class="container-fluid">
    ...
    <div class="col-md-3">
        ...
        <br>
         <div id="first_div">
             <div><img src="<?php echo $public_path; ?>images/no_image.jpg" alt="Mountain View" style="width: 100%; height:140px;">  
        </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#search_one").keyup(function(event){
            if(event.keyCode == 13){
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo $base_path; ?>Home/search",
                data: dataString,
                cache: false,
    ...
    <?php foreach ($property_list as $data) { ?>
        availableTags.push("<?php echo $data; ?>");
    <?php } ?>
